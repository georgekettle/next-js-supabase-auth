    ...
    return (
        <form>
            ...
            <div className="relative">
                ...
                <input type="search" id="default-search" className="block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-md bg-gray-50 focus:ring-gray-900 focus:ring-0 focus:border-gray-900" placeholder="Search Mockups, Logos..." required />
